    ...
    <nav className="fixed top-0 left-0 right-0 bg-blue-900 dark:bg-gray-900 text-white shadow-lg z-50">
          ...
          >
            <Link to="/" className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-200 dark:text-blue-400">Your Travel Companion</p>
              </div>
            </Link>
          </motion.div>
            ...
            <>
              ...
              >
                <div className="flex items-center space-x-1">
                  ...
                  <NavLink to="#check-status" icon={Search}>
                    Flight Status
                  </NavLink>
                  <NavLink to="/book" icon={Calendar}>
                    Book
                  </NavLink>
                  <NavLink to="/schedule" icon={Clock}>
                    Schedule
                  </NavLink>
                  <NavLink to="/tracker" icon={Radio}>
                    Tracker
                  </NavLink>
                </div>
                ...
                <div className="flex items-center space-x-1">
                  <NavLink to="/travel-guide" icon={Compass}>
                    Guide
                  </NavLink>
                  <NavLink to="/vacation-counselor" icon={Map}>
                    Plan
                  </NavLink>
      ...
      <div className="bg-blue-800 dark:bg-blue-800 py-2 text-center text-sm">
        <p className="text-white">
          Need help planning your trip? Let our Vacation Counselors assist you — at no extra cost!{' '}
